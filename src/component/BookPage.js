...
function BookPage({ booking, limit, setPageNo, pageNo }) {
    ...
    return (
        <div className="pagination-festum">
            <p className="show-text">Showing {(booking?.page -1)*limit + 1} to {Math.min((booking?.page)*limit, booking?.totalDocs)} Of {booking?.totalDocs} Bookings</p>
            <ul className="">
                <li>
