...
function Invoice() {
    ...
    const invoiceList = async () => {
        try {
            const response = await axios.get(`${baseUrl}/organizer/invoice/list`, { headers: header });
        ...
        <div className="wrapper min-h-full">
            ...
            <div className="space-y-8 h-full">
                ...
                <div className="space-y-2.5">
                    {invoice.map((e, i) => (
                        <div key={e?._id} className="w-full bg-white flex justify-between p-6 rounded-lg" onClick={handelerInviceDetails}>
